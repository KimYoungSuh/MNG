    ...
    while True:
        ...
        for i in range(0, E_NUM):
            ...
            if _Enemy_Data[2] == 1:
                ...
                newEnemy.update(f_time, _player.x, _player.y, _Bg.window_left, _Bg.window_bottom, State)
            if _Enemy_Data[2] == 2:
...
def update(frame_time):
    global E_NUM ,_Enemy_Data,unpacked_all_player_data ,f_time
    f_time=frame_time
