            ...
            if state == b'JOIN!':  # 방 입장할때
                ...
                while ready_state == 1:
                    ...
                    Packed_All_Player = struct.pack('=BBBBBBBi',
                                                    ...
                                                    game_sys_main.waitting_room_data['player1_witch_select'],
                                                    game_sys_main.waitting_room_data['player2_witch_select'],
                                                    game_sys_main.waitting_room_data['player3_witch_select'],
